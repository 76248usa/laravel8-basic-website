  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">TransCare Dashboard</span>
                </a>
              </div>
            </div>
    ...
    @if(session('success'))
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2024 TransCare Dashboard
          <a class="text-primary" href="http://www.google.com/" target="_blank">Transcare</a>.
        </p>
      </div>
    </div>
</body>
